...
const ::uint32_t TableStruct_error_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(
    protodesc_cold) = {
    ~0u,  // no _has_bits_
    PROTOBUF_FIELD_OFFSET(::bess::pb::Error, _internal_metadata_),
    ~0u,  // no _extensions_
    ~0u,  // no _oneof_case_
    ...
    ~0u,  // no _split_
    ~0u,  // no sizeof(Split)
    PROTOBUF_FIELD_OFFSET(::bess::pb::Error, _impl_.code_),
    PROTOBUF_FIELD_OFFSET(::bess::pb::Error, _impl_.errmsg_),
};

static const ::_pbi::MigrationSchema
    schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
        {0, -1, -1, sizeof(::bess::pb::Error)},
};

static const ::_pb::Message* const file_default_instances[] = {
    &::bess::pb::_Error_default_instance_._instance,
};
const char descriptor_table_protodef_error_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
    "\n\013error.proto\022\007bess.pb\"%\n\005Error\022\014\n\004code\030"
...
Error::Error(::google::protobuf::Arena* arena)
  ...
  SharedCtor(arena);
  // @@protoc_insertion_point(arena_constructor:bess.pb.Error)
}
...
const ::_pbi::TcParseTable<1, 2, 0, 28, 2> Error::_table_ = {
  {
    0,  // no _has_bits_
    0, // no _extensions_
...
::uint8_t* Error::_InternalSerialize(
  ...
  if (!this->_internal_errmsg().empty()) {
    ...
    ::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
        _s.data(), static_cast<int>(_s.length()), ::google::protobuf::internal::WireFormatLite::SERIALIZE, "bess.pb.Error.errmsg");
